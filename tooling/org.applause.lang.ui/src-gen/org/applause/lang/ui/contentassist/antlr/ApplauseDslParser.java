		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConstantAccess().getLanguageAlternatives_3_0(), "rule__Constant__LanguageAlternatives_3_0");
					put(grammarAccess.getConstantAccess().getLanguageAlternatives_5_1_0(), "rule__Constant__LanguageAlternatives_5_1_0");
					...
					put(grammarAccess.getProviderConstructionAccess().getAlternatives_0_3(), "rule__ProviderConstruction__Alternatives_0_3");
					...
					put(grammarAccess.getSectionIdAccess().getGroup(), "rule__SectionId__Group__0");
					...
					put(grammarAccess.getTableViewAccess().getGroup_3(), "rule__TableView__Group_3__0");
					put(grammarAccess.getTableViewAccess().getGroup_5(), "rule__TableView__Group_5__0");
					...
					put(grammarAccess.getDetailsViewAccess().getGroup_3(), "rule__DetailsView__Group_3__0");
					...
					put(grammarAccess.getViewSectionAccess().getGroup_3(), "rule__ViewSection__Group_3__0");
					put(grammarAccess.getViewForAllSectionsAccess().getGroup(), "rule__ViewForAllSections__Group__0");
					put(grammarAccess.getViewForAllSectionsAccess().getGroup_3(), "rule__ViewForAllSections__Group_3__0");
					put(grammarAccess.getViewForAllSectionsAccess().getGroup_4(), "rule__ViewForAllSections__Group_4__0");
					...
					put(grammarAccess.getSectionCellAccess().getGroup_9(), "rule__SectionCell__Group_9__0");
					put(grammarAccess.getCollectionIteratorAccess().getGroup(), "rule__CollectionIterator__Group__0");
					put(grammarAccess.getActionDelegateAccess().getGroup(), "rule__ActionDelegate__Group__0");
					...
					put(grammarAccess.getConstantAccess().getLanguageAssignment_3(), "rule__Constant__LanguageAssignment_3");
					put(grammarAccess.getConstantAccess().getValueAssignment_4(), "rule__Constant__ValueAssignment_4");
					put(grammarAccess.getConstantAccess().getLanguageAssignment_5_1(), "rule__Constant__LanguageAssignment_5_1");
					put(grammarAccess.getConstantAccess().getValueAssignment_5_2(), "rule__Constant__ValueAssignment_5_2");
					...
					put(grammarAccess.getProviderConstructionAccess().getArgumentAssignment_0_3_0(), "rule__ProviderConstruction__ArgumentAssignment_0_3_0");
					put(grammarAccess.getProviderConstructionAccess().getPredefinedParameterAssignment_0_3_1(), "rule__ProviderConstruction__PredefinedParameterAssignment_0_3_1");
					...
					put(grammarAccess.getTableViewAccess().getSuperViewAssignment_3_1(), "rule__TableView__SuperViewAssignment_3_1");
					put(grammarAccess.getTableViewAccess().getTitleAssignment_5_1(), "rule__TableView__TitleAssignment_5_1");
					put(grammarAccess.getTableViewAccess().getForAllSectionsAssignment_6(), "rule__TableView__ForAllSectionsAssignment_6");
					...
					put(grammarAccess.getDetailsViewAccess().getSuperViewAssignment_3_1(), "rule__DetailsView__SuperViewAssignment_3_1");
					...
					put(grammarAccess.getDetailsViewAccess().getForAllSectionsAssignment_8(), "rule__DetailsView__ForAllSectionsAssignment_8");
					put(grammarAccess.getDetailsViewAccess().getSectionsAssignment_9(), "rule__DetailsView__SectionsAssignment_9");
					...
					put(grammarAccess.getViewSectionAccess().getTitleAssignment_3_1(), "rule__ViewSection__TitleAssignment_3_1");
					put(grammarAccess.getViewSectionAccess().getCellsAssignment_4(), "rule__ViewSection__CellsAssignment_4");
					put(grammarAccess.getViewForAllSectionsAccess().getTitleAssignment_3_1(), "rule__ViewForAllSections__TitleAssignment_3_1");
					put(grammarAccess.getViewForAllSectionsAccess().getProviderAssignment_4_1(), "rule__ViewForAllSections__ProviderAssignment_4_1");
					put(grammarAccess.getViewForAllSectionsAccess().getCellsAssignment_5(), "rule__ViewForAllSections__CellsAssignment_5");
					...
					put(grammarAccess.getSectionCellAccess().getButtonActionAssignment_9_1(), "rule__SectionCell__ButtonActionAssignment_9_1");
