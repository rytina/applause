...
public interface ApplauseDslPackage extends EPackage
{
   ...
   * @ordered
   */
  int SECTIONED_VIEW__SUPER_VIEW = VIEW_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int SECTIONED_VIEW__TITLE = VIEW_FEATURE_COUNT + 1;
